      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-20 sm:space-y-36 lg:space-y-48">
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-1">
            <span className="font-headline text-6xl md:text-8xl text-secondary-fixed-dim/30 select-none">I.</span>
          </div>
          <div className="md:col-span-6">
            ...
            <div className="flex items-center gap-4 text-secondary font-label text-xs uppercase tracking-widest">
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5 order-2 md:order-1 relative">
            <div className="aspect-[4/5] bg-surface-container-high overflow-hidden rounded-sm border border-outline-variant/20 shadow-2xl flex items-center justify-center">
              {cms.step2_image
                ...
                : <span className="material-symbols-outlined text-primary/20 text-[8rem]">videocam</span>
              }
            </div>
            {!cms.step2_image && (
          ...
          <div className="md:col-span-1 order-3 text-right">
            <span className="font-headline text-6xl md:text-8xl text-secondary-fixed-dim/30 select-none">II.</span>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-1">
            <span className="font-headline text-6xl md:text-8xl text-secondary-fixed-dim/30 select-none">III.</span>
          </div>
          <div className="md:col-span-6">
            ...
            {cms.step3_image ? (
              ...
              <div className="p-8 glass-card-dark border border-outline-variant/30 rounded-lg shadow-inner">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <span className="text-[10px] uppercase tracking-widest text-secondary opacity-60 font-light">Archive ID: 772-ALX</span>
                </div>
                ...
                <div className="aspect-square bg-surface-container-highest flex items-center justify-center rounded-sm">
                  <span className="material-symbols-outlined text-secondary/40 text-6xl">picture_as_pdf</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="group p-8 bg-surface-container border border-outline-variant/10 rounded-lg hover:border-secondary/40 transition-all cursor-pointer">
                <span className="material-symbols-outlined text-secondary mb-4 block text-2xl">{item.icon}</span>
                ...
                <div className="text-xs font-label uppercase tracking-widest text-secondary flex items-center gap-2">
