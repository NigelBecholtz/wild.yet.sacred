    ...
    <div className="bg-surface text-on-surface">
      ...
      <section className="relative min-h-[60vh] sm:min-h-[700px] flex flex-col justify-center px-4 sm:px-8 md:px-24 glow-nebula overflow-hidden py-24 sm:py-0">
        ...
        <div className="max-w-4xl relative z-10">
          <span className="font-label text-sm uppercase tracking-[0.3em] text-on-surface mb-6 block font-light">
          ...
          <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-on-surface mb-6 sm:mb-8 tracking-tighter leading-[1.1]">
            ...
            Archival <span className="italic font-light text-on-surface">Readings</span>
          </h1>
        ...
        <div className="absolute bottom-8 sm:bottom-12 left-4 sm:left-8 md:left-24 animate-bounce">
          <span className="material-symbols-outlined text-on-surface opacity-50">arrow_downward</span>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-20 sm:space-y-36 lg:space-y-48">
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-1">
            <span className="font-headline text-6xl md:text-8xl text-on-surface/30 select-none">I.</span>
          </div>
          <div className="md:col-span-6">
            ...
            <div className="flex items-center gap-4 text-on-surface font-label text-xs uppercase tracking-widest">
          ...
          <div className="md:col-span-5 relative">
            <div className="aspect-[4/5] bg-surface-container overflow-hidden rounded-sm border border-outline-variant/20 shadow-2xl flex items-center justify-center">
              {cms.step1_image
                ...
                : <span className="material-symbols-outlined text-on-surface/20 text-[8rem]">style</span>
              }
            </div>
            <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 w-24 h-24 sm:w-32 sm:h-32 glass-card-dark rounded-full flex items-center justify-center border border-secondary/20">
              <span className="material-symbols-outlined text-on-surface text-4xl">star</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5 order-2 md:order-1 relative">
            <div className="aspect-[4/5] bg-surface-container-high overflow-hidden rounded-sm border border-outline-variant/20 shadow-2xl flex items-center justify-center">
              {cms.step2_image
                ...
                : <span className="material-symbols-outlined text-on-surface/20 text-[8rem]">videocam</span>
              }
            </div>
            {!cms.step2_image && (
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="w-20 h-20 bg-primary-container rounded-full flex items-center justify-center border border-primary/40 shadow-[0_0_30px_rgba(115,3,3,0.45)]">
                  <span className="material-symbols-outlined text-on-surface text-3xl">videocam</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="md:col-span-1 order-3 text-right">
            <span className="font-headline text-6xl md:text-8xl text-on-surface/30 select-none">II.</span>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-1">
            <span className="font-headline text-6xl md:text-8xl text-on-surface/30 select-none">III.</span>
          </div>
          <div className="md:col-span-6">
            ...
            {cms.step3_image ? (
              ...
              <div className="p-8 glass-card-dark border border-outline-variant/30 rounded-lg shadow-inner">
                <div className="flex justify-between items-start mb-12">
                  <div className="h-12 w-1 bg-secondary opacity-80" />
                  <span className="text-[10px] uppercase tracking-widest text-on-surface opacity-60 font-light">Archive ID: 772-ALX</span>
                </div>
                ...
                <div className="aspect-square bg-surface-container-highest flex items-center justify-center rounded-sm">
                  <span className="material-symbols-outlined text-on-surface/40 text-6xl">picture_as_pdf</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="group p-8 bg-surface-container border border-outline-variant/10 rounded-lg hover:border-secondary/40 transition-all cursor-pointer">
                <span className="material-symbols-outlined text-on-surface mb-4 block text-2xl">{item.icon}</span>
                ...
                <div className="text-xs font-label uppercase tracking-widest text-on-surface flex items-center gap-2">
