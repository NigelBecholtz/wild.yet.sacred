    ...
    <div className="bg-surface">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden celestial-bg py-24 lg:py-0">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center z-10 text-left w-full">
          <div>
            <span className="font-label text-secondary-container tracking-[0.4em] uppercase mb-6 block text-sm">
            ...
            <h1 className="font-headline text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-on-surface mb-6 sm:mb-8 tracking-tight leading-tight font-light">
              ...
              <span className="italic font-normal text-secondary-container">{c('hero_subtitle', t('home.heroSubtitle'))}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-start gap-4 sm:gap-6">
              ...
              <button
                ...
                className="border border-secondary-container/40 text-secondary-container px-8 sm:px-10 py-4 rounded-sm font-label tracking-widest uppercase hover:bg-secondary-container/15 transition-all active:scale-95 font-medium text-center"
              >
          ...
          <div className="relative group mt-8 lg:mt-0">
            <div className="absolute inset-0 bg-secondary-container/20 blur-3xl rounded-full scale-90 transition-transform group-hover:scale-100 duration-1000" />
            <div className="relative rounded-xl border border-outline-variant/20 overflow-hidden w-full h-64 sm:h-80 md:h-[420px] lg:h-[500px] bg-surface-container-high flex items-center justify-center">
              {cms.hero_image
                ...
                : <span className="material-symbols-outlined text-on-surface/15 text-[8rem] sm:text-[12rem]">auto_awesome</span>
              }
            </div>
            <div className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-6 p-4 sm:p-6 glass-card rounded-lg border border-outline-variant/20 hidden md:block max-w-[220px]">
              <p className="font-headline italic text-secondary-container text-base sm:text-lg">
                "The stars are but a map <br /> to your inner world."
              </p>
            </div>
          </div>
        </div>
        <div className="absolute -bottom-20 -left-20 w-64 sm:w-96 h-64 sm:h-96 bg-secondary-container/20 rounded-full blur-[100px]" />
      ...
      <section className="py-16 sm:py-24 bg-surface-container-lowest">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {[
            ...
            >
              <span className="material-symbols-outlined text-on-surface/45 text-4xl mb-6 block">{card.icon}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 sm:mb-20 gap-6 sm:gap-8">
            <div className="max-w-xl">
              <span className="font-label text-secondary-container tracking-widest text-sm uppercase block mb-4">The Process</span>
            ...
            <div className="text-secondary-container font-headline italic text-lg sm:text-xl">◇ Sacred Geometry ◇</div>
          </div>
            ...
            <div className="space-y-16">
              {[
                ...
                <div key={step.num} className="relative pl-12">
                  <span className="absolute left-0 top-0 font-headline text-4xl text-secondary-container opacity-40">
                    {step.num}
                  </span>
            ...
            <div className="relative overflow-visible">
              <div className="aspect-[3/4] rounded-xl overflow-hidden border border-outline-variant/20 bg-surface-container flex items-center justify-center">
                {cms.process_image
                  ...
                  : <span className="material-symbols-outlined text-on-surface/15 text-[8rem] sm:text-[10rem]">style</span>
                }
              </div>
              <div className="absolute -top-8 -right-8 w-32 h-32 sm:w-40 sm:h-40 border border-secondary-container/25 rounded-full animate-[spin_20s_linear_infinite] pointer-events-none" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4 sm:gap-6">
            <div className="sm:col-span-1 md:col-span-3 h-64 sm:h-80 md:h-96 glass-card rounded-xl p-6 sm:p-8 flex flex-col justify-end group cursor-pointer relative overflow-hidden border border-outline-variant/10">
              ...
              <div className="relative z-10">
                <span className="material-symbols-outlined text-on-surface/50 text-3xl sm:text-4xl mb-3 sm:mb-4 block">favorite</span>
            ...
            <div className="col-span-1 sm:col-span-2 md:col-span-6 h-36 sm:h-48 bg-secondary-container/15 rounded-xl p-6 sm:p-8 flex items-center justify-between cursor-pointer border border-secondary-container/25 group gap-4">
              <div>
              ...
              <span className="material-symbols-outlined text-4xl sm:text-6xl text-on-surface/35 group-hover:text-on-surface/80 transition-colors shrink-0">diamond</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-32 bg-surface text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <span className="text-on-surface/25 text-3xl mb-12 block">◆ ◆ ◆</span>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="italic font-headline text-lg leading-relaxed text-on-surface px-4">
                {testimonial.text}
                <span className="block mt-6 not-italic font-label text-sm tracking-widest text-on-surface-variant">
                  {testimonial.author}
                </span>
              </div>
            ))}
      ...
      <section className="py-24 sm:py-40 bg-surface-container-lowest relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] sm:w-[800px] h-[400px] sm:h-[800px] bg-secondary-container/10 rounded-full blur-[120px]" />
